...
#define BOARD_IO_SPI2_SCK 15    //22
#define BOARD_IO_SPI2_MOSI 9    //21
#define BOARD_IO_SPI2_MISO 8    //27
...
#define BOARD_LCD_SPI_CS_PIN 11 //5
#define BOARD_LCD_SPI_DC_PIN 13 //19
#define BOARD_LCD_SPI_RESET_PIN 16  //18
#define BOARD_LCD_SPI_BL_PIN 6  //23
